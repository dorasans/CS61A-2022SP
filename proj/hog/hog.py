...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        ...
        ex = 0
        if who==0:
            sc = take_turn(strategy0(score0,score1),score0,score1,dice,goal)
            score0+=sc
            ex = hog_pile(score0,score1)
            score0+=ex
        elif who==1:
            sc = take_turn(strategy1(score1,score0),score1,score0,dice,goal)
            score1+=sc
            ex = hog_pile(score1,score0)
            score1+=ex
        who = next_player(who)
